 ...
 */
package sing.ide.contentassist.antlr;
...
import sing.ide.contentassist.antlr.internal.InternalABLParser;
import sing.services.ABLGrammarAccess;

public class ABLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ABLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ABLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getModelAccess().getAlternatives_1(), "rule__Model__Alternatives_1");
			builder.put(grammarAccess.getTeamNeededForSuccessDefaultDeclarationAccess().getAlternatives_1(), "rule__TeamNeededForSuccessDefaultDeclaration__Alternatives_1");
			builder.put(grammarAccess.getAblDeclarationAccess().getAlternatives(), "rule__AblDeclaration__Alternatives");
			builder.put(grammarAccess.getActionRegistrationAccess().getAlternatives_1(), "rule__ActionRegistration__Alternatives_1");
			builder.put(grammarAccess.getABLSimpleTypeAccess().getAlternatives(), "rule__ABLSimpleType__Alternatives");
			...
			builder.put(grammarAccess.getTeamNeededForSuccessDefaultDeclarationAccess().getGroup(), "rule__TeamNeededForSuccessDefaultDeclaration__Group__0");
			builder.put(grammarAccess.getDecisionCycleSMCallDelcarationAccess().getGroup(), "rule__DecisionCycleSMCallDelcaration__Group__0");
			builder.put(grammarAccess.getConflictDeclarationAccess().getGroup(), "rule__ConflictDeclaration__Group__0");
			builder.put(grammarAccess.getAblDeclarationAccess().getGroup_0(), "rule__AblDeclaration__Group_0__0");
			builder.put(grammarAccess.getWMERegistrationAccess().getGroup(), "rule__WMERegistration__Group__0");
			builder.put(grammarAccess.getActionRegistrationAccess().getGroup(), "rule__ActionRegistration__Group__0");
			builder.put(grammarAccess.getActionRegistrationAccess().getGroup_4(), "rule__ActionRegistration__Group_4__0");
			builder.put(grammarAccess.getActionRegistrationAccess().getGroup_4_1(), "rule__ActionRegistration__Group_4_1__0");
			builder.put(grammarAccess.getWMEDeclarationAccess().getGroup(), "rule__WMEDeclaration__Group__0");
			builder.put(grammarAccess.getWMEDeclarationAccess().getGroup_2(), "rule__WMEDeclaration__Group_2__0");
			builder.put(grammarAccess.getWMEDeclarationAccess().getGroup_4(), "rule__WMEDeclaration__Group_4__0");
			...
			builder.put(grammarAccess.getModelAccess().getImportsAssignment_1_0(), "rule__Model__ImportsAssignment_1_0");
			builder.put(grammarAccess.getModelAccess().getConstantsAssignment_1_1(), "rule__Model__ConstantsAssignment_1_1");
			builder.put(grammarAccess.getModelAccess().getBehavingEntityNameAssignment_3(), "rule__Model__BehavingEntityNameAssignment_3");
			builder.put(grammarAccess.getModelAccess().getTeamNeededForSuccessDefaultAssignment_5(), "rule__Model__TeamNeededForSuccessDefaultAssignment_5");
			builder.put(grammarAccess.getModelAccess().getDecisionCycleSMCallAssignment_6(), "rule__Model__DecisionCycleSMCallAssignment_6");
			builder.put(grammarAccess.getModelAccess().getConflicitsAssignment_7(), "rule__Model__ConflicitsAssignment_7");
			builder.put(grammarAccess.getModelAccess().getAblDeclarationsAssignment_8(), "rule__Model__AblDeclarationsAssignment_8");
			builder.put(grammarAccess.getImportDeclarationAccess().getNameAssignment_1(), "rule__ImportDeclaration__NameAssignment_1");
			builder.put(grammarAccess.getConstantDeclarationAccess().getNameAssignment_1(), "rule__ConstantDeclaration__NameAssignment_1");
			builder.put(grammarAccess.getDecisionCycleSMCallDelcarationAccess().getNameAssignment_1(), "rule__DecisionCycleSMCallDelcaration__NameAssignment_1");
			builder.put(grammarAccess.getConflictDeclarationAccess().getConflictNamesAssignment_1(), "rule__ConflictDeclaration__ConflictNamesAssignment_1");
			builder.put(grammarAccess.getAblDeclarationAccess().getAblVariableAssignment_0_0(), "rule__AblDeclaration__AblVariableAssignment_0_0");
			builder.put(grammarAccess.getWMERegistrationAccess().getWmeClassAssignment_2(), "rule__WMERegistration__WmeClassAssignment_2");
			builder.put(grammarAccess.getWMERegistrationAccess().getNameAssignment_4(), "rule__WMERegistration__NameAssignment_4");
			builder.put(grammarAccess.getActionRegistrationAccess().getAblNameAssignment_1_1(), "rule__ActionRegistration__AblNameAssignment_1_1");
			builder.put(grammarAccess.getActionRegistrationAccess().getAblName2Assignment_2(), "rule__ActionRegistration__AblName2Assignment_2");
			builder.put(grammarAccess.getActionRegistrationAccess().getTypesAssignment_4_0(), "rule__ActionRegistration__TypesAssignment_4_0");
			builder.put(grammarAccess.getActionRegistrationAccess().getTypesAssignment_4_1_1(), "rule__ActionRegistration__TypesAssignment_4_1_1");
			builder.put(grammarAccess.getActionRegistrationAccess().getActNameAssignment_7(), "rule__ActionRegistration__ActNameAssignment_7");
			builder.put(grammarAccess.getWMEDeclarationAccess().getVarNameAssignment_1(), "rule__WMEDeclaration__VarNameAssignment_1");
			builder.put(grammarAccess.getWMEDeclarationAccess().getExtendNameAssignment_2_1(), "rule__WMEDeclaration__ExtendNameAssignment_2_1");
			builder.put(grammarAccess.getWMEDeclarationAccess().getAblVariableDeclarationAssignment_4_0(), "rule__WMEDeclaration__AblVariableDeclarationAssignment_4_0");
			builder.put(grammarAccess.getPropertyDeclarationAccess().getTypeAssignment_1(), "rule__PropertyDeclaration__TypeAssignment_1");
			builder.put(grammarAccess.getPropertyDeclarationAccess().getAblNameAssignment_2(), "rule__PropertyDeclaration__AblNameAssignment_2");
			builder.put(grammarAccess.getTypeAccess().getTypeAssignment_0_0(), "rule__Type__TypeAssignment_0_0");
			builder.put(grammarAccess.getTypeAccess().getTypeAssignment_0_1(), "rule__Type__TypeAssignment_0_1");
	...
	@Override
	protected InternalABLParser createParser() {
		InternalABLParser result = new InternalABLParser(null);
