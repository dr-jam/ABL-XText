...
import sing.ide.contentassist.antlr.ABLParser;
import sing.ide.contentassist.antlr.PartialABLContentAssistParser;
import sing.ide.contentassist.antlr.internal.InternalABLLexer;
import sing.ui.contentassist.ABLProposalProvider;
import sing.ui.editor.ABLEditor;
import sing.ui.labeling.ABLDescriptionLabelProvider;
import sing.ui.labeling.ABLLabelProvider;
import sing.ui.outline.ABLOutlineTreeProvider;
import sing.ui.quickfix.ABLQuickfixProvider;
import sing.validation.ABLValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link ABLUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractABLUiModule extends DefaultXbaseUiModule {

	public AbstractABLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(sing.parser.antlr.internal.InternalABLLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return ABLParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalABLLexer.class).toProvider(LexerProvider.create(InternalABLLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return ABLValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return ABLLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(ABLDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return ABLOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return ABLQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return ABLProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialABLContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("ABL Compare");
	}
