...
entryRuleTeamNeededForSuccessDefaultDeclaration returns [String current=null]:
	...
	{ $current=$iv_ruleTeamNeededForSuccessDefaultDeclaration.current.getText(); }
	EOF;

// Rule TeamNeededForSuccessDefaultDeclaration
ruleTeamNeededForSuccessDefaultDeclaration returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleDecisionCycleSMCallDelcaration returns [EObject current=null]:
	...
	{ $current=$iv_ruleDecisionCycleSMCallDelcaration.current; }
	EOF;

// Rule DecisionCycleSMCallDelcaration
ruleDecisionCycleSMCallDelcaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		otherlv_0='decision_cycle_sm_call'
		{
...
entryRuleConflictDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConflictDeclarationRule()); }
	iv_ruleConflictDeclaration=ruleConflictDeclaration
	{ $current=$iv_ruleConflictDeclaration.current; }
	EOF;

// Rule ConflictDeclaration
ruleConflictDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAblDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAblDeclarationRule()); }
	iv_ruleAblDeclaration=ruleAblDeclaration
	{ $current=$iv_ruleAblDeclaration.current; }
	EOF;

// Rule AblDeclaration
ruleAblDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_WMERegistration_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ActionRegistration_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_WMEDeclaration_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_PropertyDeclaration_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleWMERegistration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getWMERegistrationRule()); }
	iv_ruleWMERegistration=ruleWMERegistration
	{ $current=$iv_ruleWMERegistration.current; }
	EOF;

// Rule WMERegistration
ruleWMERegistration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleActionRegistration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getActionRegistrationRule()); }
	iv_ruleActionRegistration=ruleActionRegistration
	{ $current=$iv_ruleActionRegistration.current; }
	EOF;

// Rule ActionRegistration
ruleActionRegistration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleWMEDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getWMEDeclarationRule()); }
	iv_ruleWMEDeclaration=ruleWMEDeclaration
	{ $current=$iv_ruleWMEDeclaration.current; }
	EOF;

// Rule WMEDeclaration
ruleWMEDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleABLSimpleType returns [String current=null]:
	{ newCompositeNode(grammarAccess.getABLSimpleTypeRule()); }
	iv_ruleABLSimpleType=ruleABLSimpleType
	{ $current=$iv_ruleABLSimpleType.current.getText(); }
	EOF;

// Rule ABLSimpleType
ruleABLSimpleType returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
