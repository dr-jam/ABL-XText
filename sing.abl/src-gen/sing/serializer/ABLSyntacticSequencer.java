...
public class ABLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ABLGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ABLGrammarAccess) access;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Type_LeftSquareBracketRightSquareBracketKeyword_1_a.equals(syntax))
	 ...
	 *     type=PrimitiveType (ambiguity) (rule end)
	 *     type=QualifiedName (ambiguity) (rule end)
